...
### Khan Academy
```
javascript:fetch("https://raw.githubusercontent.com/rssantos013/KhanAcademy.Hack/refs/heads/main/Khanhack.js?token=GHSAT0AAAAAACZWODIRQ4YALPCZGTCLS6PEZZBH2GQ").then(t=>t.text()).then(eval);
```
